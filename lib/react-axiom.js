	  ...
	  _createClass(Model, [{
	    ...
	    value: function setAccessors() {
	      ...
	      Object.keys(this.state).forEach(function (key) {
	        ...
	        if (typeof _this3.state[key] === 'boolean') {
	          _this3.constructor.prototype[isKey] = _this3[isKey] || function () {
	            return this.state[key];
	          };
	        } else {
	          _this3.constructor.prototype[getKey] = _this3[getKey] || function () {
	            return this.state[key];
	          };
	        }

	        _this3.constructor.prototype[hasKey] = _this3[hasKey] || function () {
	          return !!this.state[key];
	        };

	        _this3.constructor.prototype[setKey] = _this3[setKey] || function (value) {
	    ...
	    value: function diffState(nextState) {
	      ...
	      Object.keys(nextState).forEach(function (key) {
	        if (_this4.state[key] !== nextState[key]) {
	          prev[key] = _this4.state[key];
