  ...
  _createClass(Store, [{
    ...
    value: function _toSerialState(state, store) {
      ...
      return (0, _mapValues2.default)(_state, function (value, key) {
        return _this5._toSerial(_state[key], store);
      });
    }
  }, {
    key: '_toSerialModel',
    ...
    value: function _fromSerialModel(model, models, newModels) {
      ...
      var newModel = new Store.modelsHash[_constructor](Object.assign(this._fromSerial(models[_constructor][_id], models, newModels), { store: this }));
